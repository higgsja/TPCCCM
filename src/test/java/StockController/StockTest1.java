...
//        String sql;
//
//        sql = "insert ignore into hlhtxc5_dmOfx_dev.OpeningStock () values(JoomlaId, FiTId, Ticker, EquityId, DateOpen, ShPerCtrct, Units, PriceOpen, TotalOpen, SubAcctSec, SubAcctFund, EquityType, TransactionType";
...
//
//        sql = "insert ignore into hlhtxc5_dmOfx_dev.ClosingStock () values(JoomlaId, FiTId, Ticker, EquityId, DateClose, ShPerCtrct, Units, PriceClose, TotalClose, SubAcctSec, SubAcctFund, EquityType, TransactionType";
