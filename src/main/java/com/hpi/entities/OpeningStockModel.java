...
//    // buy (Bought) and sell short (Sold Short) from etradeTransactions, 2026-06-17 forward
//    // superseded: etradeHarness --transactions populates OpeningStock directly
//    public static final String ETRADE_OPENING_STOCK =
//        "insert ignore into hlhtxc5_dmOfx.OpeningStock"
//        + " (DMAcctId, JoomlaId, DateOpen, FiTId, ReversalFiTId, Units, PriceOpen, MarkUpDn, Commission, Taxes, Fees, TransLoad, TotalOpen, CurSym, SubAcctSec, SubAcctFund, EquityId, Ticker, TransactionType, Comment, EquityType)"
//        + " select dm_acct_id, joomla_id, DATE(transaction_date), CAST(transaction_id AS CHAR), NULL,"
//        + " brk_quantity, brk_price, 0, 0, 0, brk_fee, 0, amount, 'USD', 'CASH', 'CASH',"
//        + " equity_id, prd_symbol, transaction_type, '', 'STOCK'"
//        + " from hlhtxc5_dmOfx.EtradeTransactions"
//        + " where joomla_id = '%s'"
//        + " and prd_security_type = 'EQ'"
//        + " and transaction_type in ('Bought', 'Sold Short')"
