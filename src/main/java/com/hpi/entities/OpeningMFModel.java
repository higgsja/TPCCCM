...
//    private final String secName;
    ...
    public static final String ALL_FIELDS =
        "DMAcctId, JoomlaId, FiTId, SecId, EquityId, Ticker, GMTDtTrade, GMTDtSettle, Units, UnitPrice, MarkUpDn, Commission, Taxes, Fees, TransLoad, Total, CurSym, SubAcctSec, SubAcctFund, ReversalFiTId, BuyType, RelFiTID";

    public static final String DEMO_FIELDS =
        "FiTId, SecId, EquityId, Ticker, GMTDtTrade, GMTDtSettle, Units, UnitPrice, MarkUpDn, Commission, Taxes, Fees, TransLoad, Total, CurSym, SubAcctSec, SubAcctFund, ReversalFiTId, BuyType, RelFiTID";
