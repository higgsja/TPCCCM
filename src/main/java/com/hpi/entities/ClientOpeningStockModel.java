...
{
    public static final String DMOFX = "insert ignore into hlhtxc5_dmOfx_dev.OpeningStock (%s) select %s from hlhtxc5_dmOfx_dev.ClientOpeningStock where not(Units = 0) and JoomlaId = '%s';";
    
    public static final String DMOFX_UNITS_UPDATE = "update hlhtxc5_dmOfx_dev.OpeningStock, hlhtxc5_dmOfx_dev.ClientOpeningStock set ClientOpeningStock.Units = 0.0 where OpeningStock.DMAcctId = ClientOpeningStock.DMAcctId and OpeningStock.JoomlaId = ClientOpeningStock.JoomlaId and OpeningStock.FiTId = ClientOpeningStock.FiTId and ClientOpeningStock.JoomlaId = '%s';";
