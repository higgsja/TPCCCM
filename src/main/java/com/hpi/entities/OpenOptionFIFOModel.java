...
//    public static final String UPDATE_MKTVAL = "update hlhtxc5_dmOfx_dev.OpenOptionFIFO as osf, hlhtxc5_dmOfx_dev.Util_LastDailyOption as lds set MktVal = Price * Units * ShPerCtrct where osf.EquityId = lds.EquityId and JoomlaId = '%s';";
//    
//    public static final String CLEAR_MKTVAL = "update hlhtxc5_dmOfx_dev.OpenOptionFIFO set MktVal = 0.0 where JoomlaId = '%s';";
    
    public static final String INSERT_ALL_VALUES = "insert into hlhtxc5_dmOfx_dev.OpenOptionFIFO (%s) values ";
    
//    public static final String UPDATE_GAIN = "update hlhtxc5_dmOfx_dev.OpenOptionFIFO, hlhtxc5_dmOfx_dev.Util_LastDailyOption set OpenOptionFIFO.GainPct = if (Units < 0, -round(100 * (Util_LastDailyOption.Price - OpenOptionFIFO.PriceOpen)/OpenOptionFIFO.PriceOpen, 4), round(100 * (Util_LastDailyOption.Price - OpenOptionFIFO.PriceOpen)/OpenOptionFIFO.PriceOpen, 4)) where Util_LastDailyOption.EquityId = OpenOptionFIFO.EquityId and OpenOptionFIFO.JoomlaId ='%s'";
...
public static final String ACTIVE_OPTIONS = "select EquityId from hlhtxc5_dmOfx_dev.OpenOptionFIFO oof where oof.DateExpire >= curdate();";
