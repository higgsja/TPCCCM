...
public class ClosingStockModel {
    ...
    public static final String DBOFX_UPDATE =
        "update hlhtxc5_dmOfx_dev.ClosingStock, hlhtxc5_dbOfx_dev.InvTran set hlhtxc5_dbOfx_dev.InvTran.Complete = 1 where hlhtxc5_dmOfx_dev.ClosingStock.FiTId = hlhtxc5_dbOfx_dev.InvTran.FiTId and hlhtxc5_dbOfx_dev.InvTran.AcctId = hlhtxc5_dmOfx_dev.ClosingStock.DMAcctId and hlhtxc5_dmOfx_dev.ClosingStock.JoomlaId  = '%s';";
